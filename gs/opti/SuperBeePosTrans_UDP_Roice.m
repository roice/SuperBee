...
function NatNetMatlabSample()
    ...
    % close all ports
    delete(instrfindall);
    % Open UDP ports, SuperBee_1 IP is 192.168.10.61
    global commUDP;
    commUDP = udp('192.168.10.61', 8899, 'LocalPort', 8899);
    fopen(commUDP);
    ...
    try
        ...
        if(usePollingTimer)
            ...
            framePerSecond = 10;   % 200HZ to 50HZ for remote control timer frequency
